...
outdir <- "sex_linked_snp_density_results_2"
...
label_df <- stats[consistent_direction == TRUE & is.finite(delta_male_female_nadia) & is.finite(delta_male_female_cb),
  .(gene_id, delta_male_female_nadia, delta_male_female_cb)
]
