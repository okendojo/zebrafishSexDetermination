...
cd /data/okendojo/zebrafish/data/annotation/fish11

python3 /data/okendojo/zebrafish/data/fish6/asm/t2t/polishing/eval/egapx/ui/egapx.py fish11.yaml -o NHGRI_Fish11 -e biowulf_cluster
