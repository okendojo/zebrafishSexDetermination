...
DIR="/data/okendojo/zebrafish/data/centromere_analysis/satelliteRepFinder/fish6"
...
kmc -fq -k151 -t16 -ci100 -cs100000 @hifi.txt count.kmc tmp_dir
...
minimap2 -c -N1000000 -f1000 -r100,100 -t16 srf.enlong.fa fish6.fasta > srf.paf
