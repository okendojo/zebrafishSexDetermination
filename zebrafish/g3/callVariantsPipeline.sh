...
#SBATCH --job-name=variantCallPipeline
...
STAR --runMode genomeGenerate --sjdbOverhang 149 --genomeDir  star_index/ --genomeFastaFiles /data/okendojo/zebrafish/refGenome/GRCz11_genomic.fasta --sjdbGTFfile /data/okendojo/zebrafish/refGenome/GRCz11_genomic.gtf

#2. Map reads to the reference genome

# define variables

genome_index="/data/okendojo/zebrafish/refGenome/star_index"
...
for sample in "${samples[@]}"; do
    ...
    echo "Mapping for $sample is complete"
