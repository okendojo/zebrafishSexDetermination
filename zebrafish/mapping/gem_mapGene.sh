...
#SBATCH --job-name=MAP_GEM_MAPPING_sam
...
WKDIR="/data/okendojo/zebrafish/data/centromere_analysis/satelliteRepFinder/fish11/GEM_MAPPING"
...
#Paired-end mapping
gem-mapper -I fish11_T2T.gem -1 $R1 -2 $R2 -z --report-file=analysis_report_map --output-format='MAP' -p  -t 24 -o fish11_illumina_pe.map
